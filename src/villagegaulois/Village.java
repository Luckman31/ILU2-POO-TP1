...
public class Village {
	...
	private static class Marche {
		...
		private String afficherMarche() {
			...
			afficher.append("Il reste " + compteurvide + " �tals non utilis�s dans le march�.\n");
	...
	public String installerVendeur(Gaulois vendeur, String produit, int nbProduit) {
		...
		if (libre != -1) {
			afficher.append("Le vendeur " + vendeur.getNom() + " vend des " + produit + " � l'�tal n�"
	...
	public String rechercherVendeursProduit(String produit) {
		...
		StringBuilder afficher = new StringBuilder();
		if (etal.length == 0) {
			afficher.append("Il n'y a pas de vendeur qui propose des " + produit + " au march�\n");
		} else if (etal.length == 1) {
			afficher.append(
					"Seul le vendeur " + etal[0].getVendeur().getNom() + " propose des " + produit + " au march�\n");
		} else {
